    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                ...
                {/* Sekcja bonusu powitalnego */}
                {canRegister && (
                    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                        <div className="bg-blue-50 border-l-4 border-blue-500 rounded-lg shadow-md p-6">
                            <div className="flex md:items-center flex-col md:flex-row">
                                <div className="flex-1 mb-4 md:mb-0">
                                    <h3 className="text-xl font-bold text-blue-800 mb-2">Odbierz 1000 PLN bonusu powitalnego!</h3>
                                    <p className="text-blue-700 mb-2">
                                        Załóż swoje pierwsze konto bankowe i skorzystaj z premii powitalnej.
                                    </p>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Bonus jest przyznawany automatycznie przy zakładaniu pierwszego konta.
                                    </p>
                                </div>
